...
class Tag(Base):
    """Ingredients Service owns this table (CATEGORY/ALLERGEN/SWEETENER/HEALTH_LABEL
    codebook) — main-service only reads it, to validate/resolve user_preferences.tag_id.
    """
